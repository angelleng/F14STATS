...
Sample | LS | AIC | PCR | PRS |Ridge 
------------ | ------------- | ------------ | --- | --- | ---
Training | `r m1.rmse.tr` | `r m2.rmse.tr` | `r m4.rmse.tr` | `r m5.rmse.tr` | `r m6.rmse.tr`
Test | `r m1.rmse.ts`  | `r m2.rmse.ts` | `r m4.rmse.ts` | `r m5.rmse.ts` | `r m6.rmse.ts`